...
class PreferencesOyaDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesOyaDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesOyaDialog object.
        """
        builder = get_builder('PreferencesOyaDialog')
        new_object = builder.get_object("preferences_oya_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesOyaDialog object with it in order to
        finish initializing the start of the new PerferencesOyaDialog
        instance.
